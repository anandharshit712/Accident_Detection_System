...
def visualize_isolation_tree(model, features, output_path='/Detection_model_mobile/isolation_forest_tree_visualization.png'):
    """
...
def plot_isolation_feature_importance(model, features, output_path='/Detection_model_mobile/isolation_forest_feature_importance.png'):
    """
